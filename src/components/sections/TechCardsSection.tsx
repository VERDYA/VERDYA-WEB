      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {techCards.map((card) => (
            ...
            >
              {/* Stacked Cards Effect - Card base (mais atrás) */}
              <div className="absolute inset-0 bg-gray-800 rounded-2xl transform transition-all duration-500 translate-y-2 opacity-50 group-hover:translate-y-3 group-hover:opacity-30"></div>
              
              {/* Stacked Cards Effect - Card do meio */}
              <div className="absolute inset-0 bg-gray-800/80 rounded-2xl transform transition-all duration-500 translate-y-1 opacity-75 group-hover:translate-y-2 group-hover:opacity-50"></div>

              {/* Card Container Principal */}
              <div className="relative card-bg p-8 rounded-2xl border border-gray-700 h-full transition-all duration-500 transform hover:border-gray-600 group-hover:-translate-y-4 group-hover:border-lime-500 group-hover:shadow-2xl group-hover:shadow-lime-500/20">
                {/* Content */}
                <div className="relative z-10">
                  {/* Icon */}
                  <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 transition-all duration-500 bg-lime-500/10 text-lime-400 group-hover:text-white group-hover:shadow-lg">
                    {card.icon}
                  </div>
                  ...
                  <Link href={card.route}>
                    <button className="w-full py-3 px-6 rounded-xl font-semibold transition-all duration-300 bg-lime-500/10 text-lime-400 border border-lime-500/30 hover:bg-lime-500/20 group-hover:bg-lime-500 group-hover:text-gray-900 group-hover:shadow-lg group-hover:scale-105 group-hover:border-transparent">
